    ...
    <div class="row mb-8">
        <div class="col-md-12">
            <div class="d-md-flex justify-content-between align-items-center">
                ...
                <div>
                    <a href="/admin/child-categories" class="btn btn-light">Back to Child Categories</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-lg-12 col-12">
            ...
            <div class="card mb-6 shadow border-0">
                ...
                <div class="card-body p-6">
                    ...
                    <div class="mb-4 d-flex">
                        <div class="position-relative">
                            <img class="image icon-shape icon-xxxl bg-light rounded-4"
                                src="{{ $childCategory->image ? asset('storage/' . $childCategory->image) : asset('assets/images/icons/default-image.svg') }}" alt="Image" />
                    ...
                    <form action="{{ route('child-categories.update', $childCategory->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <!-- input -->
                            ...
                            <div class="mb-3 col-lg-6">
                                ...
                                <select name="category_parent_id" class="form-select">
                                    ...
                                    @foreach ($parentCategories as $parent)
                                        <option value="{{ $parent->id }}" {{ $childCategory->category_parent_id == $parent->id ? 'selected' : '' }}>
                                            {{ $parent->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="mb-3 col-lg-12">
                                ...
                                <textarea class="form-control" name="descriptions" rows="3" required>{{ old('descriptions', $childCategory->descriptions) }}</textarea>
                            </div>
                        </div>
