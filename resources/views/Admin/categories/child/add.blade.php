    ...
    <div class="row mb-8">
        <div class="col-md-12">
            <div class="d-md-flex justify-content-between align-items-center">
                ...
                <div>
                    <a href="/admin/categories" class="btn btn-light">Back to Categories</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-lg-12 col-12">
            ...
            <div class="card mb-6 shadow border-0">
                ...
                <div class="card-body p-6">
                    <form action="{{ route('child-categories.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <h4 class="mb-5 h5">Category Image</h4>
                        <div class="mb-4 d-flex">
                            <div class="position-relative">
                                <img class="image icon-shape icon-xxxl bg-light rounded-4" src="{{ asset('assets/images/icons/bakery.svg') }}" alt="Image" />
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col-lg-6">
                                ...
                                <select name="category_parent_id" class="form-select" required>
                            ...
                            <div class="mb-3 col-lg-12">
                                ...
                                <textarea name="descriptions" class="form-control" rows="4" placeholder="Enter descriptions here..." required></textarea>
                            </div>
