    ...
    <div class="row mb-8">
        <div class="col-md-12">
            <div class="d-md-flex justify-content-between align-items-center">
                ...
                <!-- button -->
                <div>
                    <a href="{{ route('parent-categories.create') }}" class="btn btn-primary">Add New Parent Category</a>
                </div>
            </div>
        </div>
    </div>
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li><a class="dropdown-item" href="{{ route('parent-categories.edit', $category->id) }}"><i class="bi bi-pencil-square me-3"></i>Edit</a></li>
                                                    <li>
                                                        <form action="{{ route('parent-categories.destroy', $category->id) }}" method="POST">
                                                            @csrf
                                                            @method('DELETE')
